# Pharynx Wave Detection and Analysis & Phenotypic Clustering
...
1.  **Pharynx Wave Analysis (Python):** Detection of pumping events from electrophysiological recordings. Please read README_Pharynx_Wave_Detection.md.
2.  **Hierarchical Clustering (MATLAB):** Generation of biomechanical heatmaps. Please read README_HeatMapHierarchicalClustering.md.
3.  **Source Data:** Raw data underlying the figures presented in the article. Please see All_figuresData.xlsx.
